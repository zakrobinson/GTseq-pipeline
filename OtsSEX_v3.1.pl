...
#OtsSEX_v3.1.pl
#V3.1 made the cntrl_ratio an argument to the function ZLR.
#V3 update added a flag to end of the .genos concatenation and made output an equal length to standard .genos row entries. ZLR
#V3 update parallelized and takes argument for number of jobs/processors to use. ZLR
# OtsSEX_test_v2.pl
# by Nate 
# Sex fish by GTseq
...
sub ProcessFastqXY {
	...
	$cntrl_counts = $OT_reads * $ctrl_ratio; # ctrl_ratio=0.005 as of 1/2024
	...
	print OUT "Ots_SEXY3-1,X=$cntrl_counts,Y=$counts,$ratio,$sex_geno,$geno_class,0,0,$real_counts,$primerOT,$perofallOTreads,0.00,Pass,0\n";
close FILE;
close OUT;
